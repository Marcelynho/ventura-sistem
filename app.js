...
async function restaurarBackup() {
    ...
    seletorArquivo.onchange = async function (evento) {
        ...
        const confirmar = confirm(
            "Deseja restaurar os dados deste backup?"
        );
        ...
        try {
            ...
            for (const nomeColecao of colecoes) {
                const registros = backup.dados[nomeColecao] || [];
            ...
            alert(
                Backup restaurado com sucesso! ${quantidadeRestaurada} registros recuperados.
            );
